...
| ARC-02 | Dados em fonte única | Frontend | MAJOR | Inspecionar `src/data/portfolio.ts` | Parcial | rg | PASS |
...
| SEO-01 | Rotas, metas, canonical, OG, sitemap e robots | SEO | MAJOR | HTML, sitemap e rotas | Parcial | testes + browser | PASS |
...
| TEST-02 | Fluxos reais no browser | Qualidade | MAJOR | Home→Projeto→Case→Contato | Parcial | Playwright | PASS |
