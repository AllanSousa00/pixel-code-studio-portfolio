...
- Logotipo oficial do GitHub fornecido para os links do perfil
...
- `BottomNavBar`: navegação animada em `src/components/ui`, flutuando sozinha no topo e personalizada para as seções e os contatos do portfólio.
