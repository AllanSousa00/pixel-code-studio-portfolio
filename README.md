...
- `InfoCard`: card animado em `src/components/ui`, aplicado às capturas reais dos sete projetos com borda reativa, layout responsivo e suporte a movimento reduzido.
